...
/**
 * Contains methods for generating data and printing the results of each algorithm.
 * 
 * Includes the main testing client which prints comparison counts and sorted lists from each algorithm.
 * 
...
public class TestingData {
	...
	/**
	 * Prints the sorted list from each algorithm and number of comparisons made.
	 * Accepts a set of integer lists and a sorting algorithm.
	 * 
	 * @param dataset List of unsorted integer lists to be sorted.
	 * @param sorter Algorithm used for sorting.
	 * @param algorithm String for representing each algorithm.
	 */
	...
	/**
	 * Prints the dataset as a series of integer lists.
	 * 
	 * @param dataset List of unsorted integer lists.
	 */
	...
	/**
	 * Contains the dataset instantiation and method calls to each algorithm for sorting each integer list.
	 * Includes edge cases for testing the generateData() method.
	 * The results and sorted integer lists from every n-size are printed for each method an equal number of times.
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		
		// 3 datasets of 10 lists each, with sizes n = 8,6 and 4
		...
		// invalid arguments for generateData()
		List<List<Integer>> invalidN = TestingData.generateData(2, 5);
		List<List<Integer>> emptySet = TestingData.generateData(0, 4);
		List<List<Integer>> negativeSet = TestingData.generateData(-1, 4);
		
		System.out.println("Unsupported n-value: " + invalidN);
		System.out.println("Unsupported number of lists: " + emptySet);
		System.out.println("Unsupported number of lists: " + negativeSet + "\n");
		
		// Integer lists from each dataset
